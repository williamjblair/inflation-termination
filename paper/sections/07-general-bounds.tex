...
The proof uses no convexity of $\mathcal C_G$: we extract one compatible law from the witness. The bound gives a rejecting order under a promise rather than a decision procedure, since $\delta$ is not directly evaluable.
