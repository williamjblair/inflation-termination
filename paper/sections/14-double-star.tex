...
The construction samples new independent sources; it does not assume that conditioning on $E$ preserves any independence among the latent variables of a hypothetical model behind $\Gamma$. The only fact used about $\Gamma$ is \eqref{eq:condmarg}. A central source with
\(
